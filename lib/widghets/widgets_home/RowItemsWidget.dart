...
class _RowItemsWidgetState extends State<RowItemsWidget> {
  ...
  Widget build(BuildContext context) {
    return Consumer2<OrderNotifier, ProductNotifier>(
      builder:(context,on,pn,child){
                            ...
                            children: [
                              ...
                              if(i == 1) ...[
                                Row(
                                  children: [
                                    Text(
                                      on.danhSachHoaDon.length.toString(),
                                      style: TextStyle(
                                        color: Colors.red,
                                        fontSize: 35,
                                        fontWeight: FontWeight.w500,
                                ...
                                Row(
                                  children: [
                                    Text(
                                      pn.danhSachSanPham.length.toString(),
                                      style: TextStyle(
                                        color: Colors.red,
                                        fontSize: 35,
                                        fontWeight: FontWeight.w500,
